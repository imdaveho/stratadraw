defmodule StratadrawWeb.UserAuthTest do
  use StratadrawWeb.ConnCase, async: true

  alias Stratadraw.Accounts
  alias Stratadraw.Accounts.Scope
  alias StratadrawWeb.UserAuth

  import Stratadraw.AccountsFixtures

  @remember_me_cookie "_stratadraw_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, StratadrawWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
