defmodule StratadrawWeb.Router do
  ...
  if Application.compile_env(:stratadraw, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard("/dashboard", metrics: StratadrawWeb.Telemetry)
  ...
  scope "/", StratadrawWeb do
    ...
    post("/patterns", PatternController, :create)
